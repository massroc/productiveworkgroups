defmodule ProductiveWorkgroupsWeb do
  @moduledoc """
  ...
  def live_view do
    quote do
      use Phoenix.LiveView,
        layout: {ProductiveWorkgroupsWeb.Layouts, :app}
  ...
  def verified_routes do
    quote do
      use Phoenix.VerifiedRoutes,
        ...
        router: ProductiveWorkgroupsWeb.Router,
        statics: ProductiveWorkgroupsWeb.static_paths()
    end
  end
